	 ...
	 (include <QGraphicsRectItem>)
       ...
       (function (main ((argc :type int)
		 ...
		 (let ((a :type QApplication :ctor (comma-list argc argv))
		   ...
		   (let ((rect :init (new (funcall QGraphicsRectItem 50 50 100 100)))
			 (rect2 :init (new (funcall QGraphicsRectItem 48 48 104 104))))
		     (funcall rect->setFlag "QGraphicsItem::ItemIsSelectable")
		     (funcall rect2->setFlag "QGraphicsItem::ItemIsSelectable")
